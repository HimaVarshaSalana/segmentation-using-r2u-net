...
def main(config):
    ...
    filenames.sort()
    gtfilenames = os.listdir(config.origin_GT_path)
    gtfilenames.sort()
    data_list = []
    GT_list = []
    print(filenames)
    ...
    for filename in filenames:
        ...
        if ext =='.tif':
            ...
            #filename = filename.removesuffix('.tif')
...
if __name__ == '__main__':
    ...
    # data path
    parser.add_argument('--origin_data_path', type=str, default='/content/drive/My Drive/Colab Notebooks/Segmentation/DRIVE/training/pr_images/')
    parser.add_argument('--origin_GT_path', type=str, default='/content/drive/My Drive/Colab Notebooks/Segmentation/DRIVE/training/GT/')
    
    parser.add_argument('--train_path', type=str, default='/content/drive/My Drive/Colab Notebooks/Segmentation/dataset/train/')
    parser.add_argument('--train_GT_path', type=str, default='/content/drive/My Drive/Colab Notebooks/Segmentation/dataset/train_GT/')
    parser.add_argument('--valid_path', type=str, default='/content/drive/My Drive/Colab Notebooks/Segmentation/dataset/valid/')
    parser.add_argument('--valid_GT_path', type=str, default='/content/drive/My Drive/Colab Notebooks/Segmentation/dataset/valid_GT/')
    parser.add_argument('--test_path', type=str, default='/content/drive/My Drive/Colab Notebooks/Segmentation/dataset/test/')
    parser.add_argument('--test_GT_path', type=str, default='/content/drive/My Drive/Colab Notebooks/Segmentation/dataset/test_GT/')
