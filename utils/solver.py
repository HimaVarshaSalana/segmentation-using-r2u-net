...
class Solver(object):
    ...
    def test(self):
        ...
        self.unet.load_state_dict(torch.load(
            'utils\(new)R2U_Net-500-0.0004-397-0.4885.pkl', map_location=torch.device('cpu')))
        ...
        # GT = Image.open('Segmentation/dataset/train_GT/40_manual1.gif')
        # GT.convert("RGB")
        ...
        print('[Test] Acc: %.4f, SE: %.4f, SP: %.4f, PC: %.4f, F1: %.4f, JS: %.4f, DC: %.4f' % (
            ...
            torchvision.utils.save_image(images.data.cpu(),
                                         os.path.join(self.result_path, 'test_preprocessed_image.png'))
            torchvision.utils.save_image(SR.data.cpu(),
                                         os.path.join(self.result_path, 'test_SR.png'))
        '''torchvision.utils.save_image(GT.data.cpu(),
                                     os.path.join(self.result_path, 'test_GT.png'))
    ...
    def train(self):
        ...
        # unet_path = '/content/drive/MyDrive/Colab Notebooks/Segmentation/models/r2u_net.pkl'
        # U-Net Train
